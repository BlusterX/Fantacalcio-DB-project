...
public class FasciaGiocatore {
    ...
    private double probRigoreParato;
    private double bonusVotoBase;
    ...
    public FasciaGiocatore(int idFascia, String nomeFascia, double probGolAttaccante,
                          ...
                          double probRigoreParato, double bonusVotoBase) {
        ...
        this.probRigoreParato = probRigoreParato;
        this.bonusVotoBase = bonusVotoBase;
    }
    ...
    private void impostaValoriDefault() {
        ...
        this.probRigoreParato = 0.25;
        this.bonusVotoBase = 0.0;
    }
    ...
    public double getProbRigoreParato() {
        return probRigoreParato;
    }
    
    public void setProbRigoreParato(double probRigoreParato) {
        this.probRigoreParato = probRigoreParato;
    }
    
    public double getBonusVotoBase() {
        return bonusVotoBase;
    }
    
    public void setBonusVotoBase(double bonusVotoBase) {
        this.bonusVotoBase = bonusVotoBase;
    }
    ...
    /**
     * Restituisce la probabilità di gol per il ruolo specificato
     */
    public double getProbGolPerRuolo(Calciatore.Ruolo ruolo) {
        return switch (ruolo) {
            ...
            case PORTIERE -> 0.0; // I portieri non segnano mai
        };
    }
    
    /**
     * Verifica se è una fascia alta (TOP o SEMI-TOP)
     */
    ...
    @Override
    public String toString() {
        return nomeFascia; // Per ComboBox
    }
}